...
file_name="f_dataset-${dataset_name}${seq_number}_512_stereoi"
...
# ARGS="../Vocabulary/ORBvoc.txt Stereo-Inertial/TUM-VI.yaml ${pathDatasetTUM_VI}/${dataset_name}/dataset-${dataset_name}${seq_number}_512_16/mav0/cam0/data ${pathDatasetTUM_VI}/${dataset_name}/dataset-${dataset_name}${seq_number}_512_16/mav0/cam1/data Stereo-Inertial/TUM_TimeStamps/dataset-${dataset_name}${seq_number}_512.txt Stereo-Inertial/TUM_IMU/dataset-${dataset_name}${seq_number}_512.txt  ${file_name} ${statsDir} ${mode}"
...
./Stereo-Inertial/stereo_inertial_tum_vi \
    ...
    ${pathDatasetTUM_VI}/${dataset_name}/dataset-${dataset_name}${seq_number}_512_16/mav0/cam0/data \
    ${pathDatasetTUM_VI}/${dataset_name}/dataset-${dataset_name}${seq_number}_512_16/mav0/cam1/data \
    Stereo-Inertial/TUM_TimeStamps/dataset-${dataset_name}${seq_number}_512.txt \
    Stereo-Inertial/TUM_IMU/dataset-${dataset_name}${seq_number}_512.txt  \
    ${file_name} ${statsDir} ${mode} ${fastmap_mode}
