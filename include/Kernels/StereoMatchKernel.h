...
private:
    ...
    void copyGPUKeypoints(const std::vector<cv::KeyPoint> keypoints, CudaKeyPoint* out);
...
public:
    CudaKeyPoint* get_d_gpuKeypointsL() { return d_gpuKeypointsL; };
    CudaKeyPoint* get_d_gpuKeypointsR() { return d_gpuKeypointsR; };
...
private:
    ...
    CudaKeyPoint *d_gpuKeypointsL, *d_gpuKeypointsR;
